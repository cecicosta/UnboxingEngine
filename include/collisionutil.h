...
public:
    ...
    static std::unordered_map<int, const SceneComposite&> mSceneComposite;


    void RegisterMesh(const CMeshBuffer &sceneNode, const SceneComposite &sceneComposite);
    static bool rayWithObject(const Vector3f& point, const Vector3f& ray, int ObjectID, Vector3f &intersection, face &poly);
